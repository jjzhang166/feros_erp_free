...
var readyHandler = function () {
    ...
    ferosClient.enableDrag();
    var pos = ferosClient.getScreenSize();
    ferosClient.move(pos.width-300, pos.height-100);
    ferosClient.setSize(270, 80);
    //ferosClient.setTopMost();
    setTimeout('ferosClient.toImage("screen.png")', 2000);
}
