...
* @version 2.0.1
*@view /Users/feisanliang/Documents/开发项目/erp2/application/view/inventory/sales_returns_query.html
*/
...
<body>
    <div class="container-fluid">
        <form id="forminventorysupplier" class="form-inline" action="<?php echo $this->url->site('inventory/sales_returns_query/'.$py);?>" accept-charset="utf-8" method="get">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <button type="button" class="btn" title="打印" onclick="PrintNoBorderTable('<?php echo $this->url->site('prints/sales_returns/'.'?session_id='.session_id());?>&'+$('form').serialize(),'打印退货订单')"><i class="icon-print"></i> 打印查询结果</button>
